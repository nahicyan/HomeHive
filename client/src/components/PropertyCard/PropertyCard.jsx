...
const PropertyCard = ({ card }) => {
  ...
  return (
    <div
      className="group relative w-full max-w-[460px] h-[380px] rounded-xl p-1 bg-gradient-to-r from-white/40 via-white/20 to-white/40 shadow-xl transition-all duration-300 hover:shadow-2xl cursor-pointer"
      ...
      <div className="absolute inset-0 bg-white/10 backdrop-blur-xl rounded-xl border border-white/30 overflow-hidden">
        ...
        <div className="p-2">
          <div className="flex justify-between mb-1">
            <h4 className="text-base font-medium text-[#4b5b4d]">
              ${formatPrice(card.askingPrice)}
            </h4>
            <p className="text-sm font-medium text-[#4b5b4d]">
              {card.acre} Acres
            </p>
          </div>
